#!/bin/bash
#PBS -l nodes=4:ppn=8,pmem=2000M,walltime=24:00:00
#PBS -N GROMACS_MD
#PBS -A account_name
#PBS -q batch128
#PBS -V
...
#grompp -maxwarn 3 -f prmdwt.mdp -c em.gro -p topol.top -o nvt.tpr >> GROMACS-$PBS_JOBID.out
#echo " " >> GROMACS-$PBS_JOBID.out
#
...
grompp -maxwarn 3 -f prmdwt.mdp -c em.gro -p topol.top -o npt.tpr >> GROMACS-$PBS_JOBID.out
echo " " >> GROMACS-$PBS_JOBID.out
